        ...
        <ul>
            ...
            <li class="mb-2">
                <a href="{{ route('jamkerja.index') }}"
                   class="block p-2 rounded {{ request()->routeIs('jamkerja.*') ? 'bg-blue-800 font-semibold' : 'hover:bg-cyan-400' }}">
                   Jam Kerja
                </a>
            </li>
            <li class="mb-2">
                <a href="{{ route('statusjamkerja.index') }}"
                   class="block p-2 rounded {{ request()->routeIs('statusjamkerja.*') ? 'bg-blue-800 font-semibold' : 'hover:bg-cyan-400' }}">
                   Status Jam Kerja
                </a>
            </li>
            <li class="mb-2">
                <a href="{{ route('modejamkerja.index') }}"
                   class="block p-2 rounded {{ request()->routeIs('modejamkerja.*') ? 'bg-blue-800 font-semibold' : 'hover:bg-cyan-400' }}">
                   Mode Jam Kerja
                </a>
            </li>
            <li>
