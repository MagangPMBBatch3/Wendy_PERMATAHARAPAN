...
@section('content')
  <div class="bg-white p-6 rounded-lg shadow-lg w-full space-y-6">
    <h1 class="text-3xl font-bold text-gray-800">📊 Data Level</h1>
    ...
    <div id="tableAktif">
      <table class="w-full border border-gray-300 rounded-md overflow-hidden">
        ...
        <tbody id="dataLevel" class="divide-y divide-gray-200">
          <tr>
    ...
    <div id="tableArsip" class="hidden">
      <table class="w-full border border-gray-300 rounded-md overflow-hidden">
        ...
        <tbody id="dataLevelArsip" class="divide-y divide-gray-200">
